...
(*avoid lots of schoutenizing to simplify a complicated expression that you know is a ratio*)

cleanRatio[n_][x_]:=allRatios[n][[Position[numRatios[n],num[n][x]][[1,1]]]];
