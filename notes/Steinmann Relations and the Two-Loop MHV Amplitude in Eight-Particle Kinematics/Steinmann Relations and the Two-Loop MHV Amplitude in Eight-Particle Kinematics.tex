...
\end{align}
In fact, the functions ${}^3 A^{\text{BDS-like}}_{8} $ and ${}^4 A^{\text{BDS-like}}_{8}$ are not uniquely fixed by this choice, as there exists a one-parameter family of Bose-symmetric solutions to these decompositions. 
...
\begin{align}
u_1 &= \frac{s_{12} s_{4567}}{s_{123} s_{812}}, \quad \text{+ cyclic (8-orbit)} \\
u_9 &= \frac{s_{123} s_{567}}{s_{1234} s_{4567}}, \quad \text{+ cyclic (4-orbit).}
\end{align}
...
\begin{align}
{}^4 d_1 &= u_1 \ u_5 = \frac{s_{12} \ s_{56} \ (s_{4567})^2}{s_{123} \ s_{456} \ s_{567} \ s_{812}}, \quad \text{+ cyclic (4-orbit)} \\
{}^4 d^4_5 &= u_1/u_5 = \frac{s_{12} \ s_{456} \ s_{567}}{s_{56} \ s_{123} \ s_{812}}, \quad \text{+ cyclic (4-orbit)} \\
{}^4 d^4_9 &= u_1 \ u_2 \ u_5 \ u_6 \ u_9^2 = \frac{s_{12} \ s_{23} \ s_{56} \ s_{67}}{s_{234} \ s_{456} \ s_{678} \ s_{812}}, \quad \text{+ cyclic (4-orbit)}
\end{align}
...
\begin{align}
{}^3 d_1 &= \frac{u_1 \ u_2 \ u_4 \ u_7}{u_3 \ u_5 \ u_6 \ u_8 \ u_9^2} = \frac{s_{12} \ s_{23} \ s_{45} \ s_{78} \ (s_{1234})^2 \ (s_{4567})^2}{s_{34} \ s_{56} \ s_{67} \ s_{81} \ (s_{123})^2}, \quad \text{+ cyclic (8-orbit)} \\
{}^3 d^4_9 &= u_1 \ u_5 \ u_9 \ u_{12} = \frac{s_{12} \ s_{56}}{s_{1234} \ s_{3456}}, \quad \text{+ cyclic (4-orbit)}
\end{align}
in which case ${}^3 d_1$ through ${}^3 d_8$ each contain a different three-particle Mandelstam invariant, as well as four-particle Mandelstams that they are not disbarred from appearing next to in the symbol. The remaining four letters only contain two- and four-particle invariants. In these letters, conditions~\eqref{stein34_5} and~\eqref{stein34_6} tell us that ${}^3 d_7, {}^3 d_8, {}^3 d_2$, and ${}^3 d_2$ can never appear next to ${}^3 d_1$ in the symbol of ${}^{3,j} {\cal E}_8$ (plus the cyclic images of these restrictions). Specializing to ${}^{3,1} {\cal E}_8$ now for concreteness, conditions~\eqref{stein34_1} through~\eqref{stein34_4} give us the additional restrictions that none of ${}^3 d_1, {}^3 d_5, {}^3 d_9$ and ${}^3 d_{10}$ can ever appear next to ${}^3 d_3, {}^3 d_4, {}^3 d_7, {}^3 d_8$.  
