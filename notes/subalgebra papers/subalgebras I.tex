...
\begin{tikzpicture}[overlay, remember picture,decoration={markings,mark=at position .99 with {\arrow[scale=1.4,>=stealth]{>}}}]
    ...
    \draw [dashed,rounded corners=1cm] ([yshift=1cm,xshift=-1.2cm]{pic cs:e6topLeft2}) rectangle ([yshift=-.6cm,xshift=1cm]{pic cs:e6bottomRight2}) ;
...
\begin{tikzpicture}[overlay, remember picture,decoration={markings,mark=at position .99 with {\arrow[scale=1.4,>=stealth]{>}}}]
    ...
    \draw [dashed,rounded corners=1cm] ([yshift=1cm,xshift=-1.2cm]{pic cs:d5topLeft3}) rectangle ([yshift=-.6cm,xshift=1cm]{pic cs:d5bottomRight3}) ;
    \draw [dashed,rounded corners=1cm] ([yshift=1cm,xshift=-1.2cm]{pic cs:e6topLeft3}) rectangle ([yshift=-.6cm,xshift=1cm]{pic cs:e6bottomRight3}) ;
