...
\abstract{We review various aspects of cluster algebras and the ways in which they appear in the study of loop-level amplitudes in planar ${\cal N} = 4$ supersymmetric Yang-Mills theory. In particular, we highlight the different forms of cluster-algebraic structure that appear in the two-loop MHV amplitudes of this theory at the level of functions, symbols, and Lie cobrackets, and review how the `nonclassical' part of these amplitudes can be constructed out of functions on the $A_2$ and $A_3$ subalgebras of $\Gr(4,n)$. We then extend this line of inquiry by searching for other subalgebras into which these amplitudes can be decomposed. We focus on the case of seven-particle kinematics, where we show that the nonclassical part of the two-loop MHV amplitude also admits $A_4$, $A_5$, and $D_5$ decompositions. Unlike the $A_3$ decompositions of this amplitude, these }
