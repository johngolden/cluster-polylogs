...
\end{scope}
\end{tikzpicture}
  \caption{The cluster polytope for $A_3\simeq\Gr(2,6)$, where each cluster is represented by a triangulation of the hexagon.}
  \label{fig:a3-poly}
\end{figure}
...
\begin{equation}\label{def:D5}
    ...
    \end{gathered} ,
\end{equation}
is not equivalent to the cluster algebra on (the top cell of) any Grassmannian. However, it appears as a subalgebra of any $\Gr(k,n)$ with rank greater than five. The $D_4$ cluster algebra consists of 50 clusters, 16 \acoords, and 104 \xcoords, while $D_5$ has 182 clusters, 25 \acoords, and 260 \xcoords. 
