...
\begin{equation}\label{table:a2-d5-counts}
\begin{tabular}{ c | c |}
...
\hline
$f_{A_5}  \in \text{span}\big(f_{A_3}^{--}\big)$ & 1 & 1 & 0 & 3
\end{tabular} 
...
\begin{gathered}
    \begin{xy} 0;<1pt,0pt>:<0pt,-1pt>::
      (0,20) *+{x_1} ="1",
      (30,20) *+{x_2} ="2",
      (72,20) *+{\begin{aligned} \frac{x_3 x_5}{1+x_5} \end{aligned}} ="3",
      (114,0) *+{\color{white} x} ="4",
      (114,40) *+{\color{white} x} ="5",
      (118,0) *+{x_4} ="6",
      (118,34) *+{\begin{aligned} \frac{1}{x_5}\end{aligned}} ="7",
      "1", {\ar"2"},
      "2", {\ar"3"},
      "3", {\ar"4"},
      "3", {\ar"5"},
...
\begin{equation}
\delta_{2,2}\big(R^{(2)}_7 \big) = \sum_{A_5\subset E_6} \delta_{2,2} \Big(f_{A_5}^{--} \left(x_1\to x_2\to \frac{x_3 x_5}{1+x_5} \to \frac{1}{x_5}  \to x_6 (1+x_5) \right) \Big), \label{eq:R27_A5_decomposition}
\end{equation}
