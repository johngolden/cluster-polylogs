...
Although there are 6 and 9 independent $A_3^{--}$\!-constructible functions in $A_4$, they cannot be put into combinations that respect the automorphisms of either algebra. In $A_5$ we find 
