...
Increasing evidence suggests that cluster algebras (or their generalizations) have a role to play in loop-level amplitudes in the planar limit of ${\cal N} = 4$ supersymmetric Yang-Mills (SYM) theory. This connection was first noted at two loops~\cite{Golden:2013xva,Golden:2013lha,Golden:2014xqa,Golden:2014pua}, where the symbol of the $n$-point maximally-helicity-violating (MHV) amplitude~\cite{CaronHuot:2011ky} was observed to involve only cluster coordinates on the grassmannian Gr(4,$n$). The same observation has subsequently been borne out at higher loop orders in six- and seven-particle kinematics both at the level of MHV and next-to-MHV (NMHV) amplitudes~\cite{Dixon:2013eka,Dixon:2014voa,Dixon:2014iba,Drummond:2014ffa,Dixon:2015iva,Caron-Huot:2016owq,Dixon:2016nkn,Drummond:2017ssj}, as well as in certain classes of Feynman integrals, some of which have been computed to all loop orders~\cite{Drummond:2017ssj,Bourjaily:2018aeq,Caron-Huot:2018dsv,Henn:2018cdp}. Even more strikingly, it has been conjectured that pairs of cluster coordinates can only appear in an amplitude's adjacent symbol entries when they also appear together in a cluster in Gr(4,$n$)~\cite{Drummond:2017ssj}, which at least for low points is equivalent to imposing the extended Steinmann relations~\cite{Steinmann,Steinmann2,Cahill:1973qp,Caron-Huot:2018dsv,to_appear}. However, the appearance of algebraic roots in Feynman integrals contributing to eight- and higher-particle amplitudes obfuscates these connections between amplitudes and cluster algebras~\cite{Prlina:2017azl,Bourjaily:2018aeq,Henn:2018cdp}, as does the appearance of functions beyond polylogarithms~\cite{}. Both complictions point to the need for some generalization of cluster algebras if a similar story is to hold at higher loops and particle multiplicities.

However, there is reason to be optimistic such a generalization exists, due to the diverse ways in which cluster-algebraic structure appears in the two-loop MHV amplitudes of this theory. In addition to having symbol alphabets composed entirely of cluster coordinates, it has been shown that the `nonclassical' part of these amplitudes is uniquely determined for all $n$ by a combination of physical and cluster-algebraic properties~\cite{Golden:2014pua}. , a pair of functions can be associated with the $A_2$ and $A_3$ subalgebras of Gr(4,$n$), in terms of which this nonclassical component of these amplitudes can be geometrically decomposed into sums over these subagebras~\cite{Golden:2014xqa}. Their remaining `classical' part can always be written as products of classical polylogarithms with arguments that~\cite{Golden:2014xqf}.\draftnote{should we phrase this as a conjecture, or as it's stated now?} .
