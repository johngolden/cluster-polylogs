...
\title{Cluster Subalgebra-Constructibility I: Introduction and Review of Cluster Algebras for Integrated Amplitudes} 
...
\abstract{We review connections between cluster algebras and integrated amplitudes in ${\cal N} = 4$ supersymmetric Yang-Mills. After a simple, pedagogical introduction to cluster algebras and some of their applications to amplitudes, we investigate ways in which amplitudes can be written as sums over cluster \emph{sub}algebras. As an example, we exhaustively search for all ways in which the `nonclassical' part of the two-loop, seven-particle remainder function can be decomposed into the cluster subalgebras of the Grassmannian Gr(4,7).}
...
\section{Subalgebra-constructibility of \pdfeq{R^{(2)}_7}}
