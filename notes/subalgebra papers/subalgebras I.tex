...
\begin{equation}
Z_{\Gr(3,6)} = \begin{pmatrix} 
 1 & 0 & 0 & 1 & x_4+1 & x_2 x_4+x_4+1 \\
 0 & 1 & 0 & -x_1-1 & -x_1 (x_4+1) & -x_1 (x_4+1) \\
 0 & 0 & 1 & (x_1 x_2+x_2+1) x_3+1 & x_1 x_2 x_3 (x_4+1) & x_1 x_2 x_3 \\
\end{pmatrix}
\end{equation}
...
\end{align}
More generally, any \acoord\ on $\Gr(4,7)$ can be expressed in terms of the \xcoords\ in~\eqref{def:E6} by evaluating them on the momentum twistor matrix \begin{equation}
Z_{\Gr(4,7)} = \begin{pmatrix} 
 1 & 0 & 0 & 0 & -x_1 x_4 x_5 x_6 & -x_3 x_4 x_5 x_6 (x_3 (x_6 x_5+x_5+1) x_4+x_4+1) & -x_3
   x_4 x_5 x_6 ((x_2+1) x_3 (x_6 x_5+x_5+1) x_4+x_4+1) \\
 0 & 1 & 0 & 0 & x_3 (x_6 x_5+x_5+1) x_4+x_4+1 & (x_4 (x_5 x_3+x_3+1)+1) (x_3 (x_6 x_5+x_5+1)
   x_4+x_4+1) & ((x_2+1) x_3 (x_5+1) x_4+x_4+1) (x_3 (x_6 x_5+x_5+1) x_4+x_4+1) \\
 0 & 0 & 1 & 0 & -x_3 (x_4+1) x_5 x_6 & -x_3 (x_4+1) x_5 x_6 & -x_3 (x_4+1) x_5 x_6 \\
 0 & 0 & 0 & 1 & x_3 ((x_1 x_2+x_2+1) x_3+1) x_4 (x_5+1) x_6 & (x_1+1) x_2 x_3^2 x_4 (x_5+1) x_6 &
   x_1 x_2 x_3^2 x_4 (x_5+1) x_6 
\end{pmatrix} \ .
\end{equation}
