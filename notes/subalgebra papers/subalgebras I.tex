...
\begin{tabular}{ c |  c | c | c | c }      
  & $\sigma^+\tau^+$ & $\sigma^+\tau^-$ & $\sigma^-\tau^+$ & $\sigma^-\tau^-$ \\
\hline
$A_4 \in \text{span}\big(f_{A_3}^{--}\big)$ & 0 & 0 & 0 & 0 \\
\hline
$A_5  \in \text{span}\big(f_{A_3}^{--}\big)$ & 1 & 1 & 0 & 3
\end{tabular} 
...
Having now seen the extent to which the $E_6$ cluster algebra admits nontrivial functional embeddings, we 
